...
public class Branch extends Node {
    ...
    public Map<Character, List<Boolean>> traverse(List<Boolean> list) {
    	// makes a deep copy of the list and adds false to it
    	ArrayList<Boolean> leftList = new ArrayList<Boolean>(list);
    	leftList.add(false);
    	// stores the resulting map of recursively calling this method on the branch's left child
    	Map<Character, List<Boolean>> leftMap = left.traverse(leftList);
    	// makes a deep copy of the list and adds true to it
    	ArrayList<Boolean> rightList = new ArrayList<Boolean>(list);
    	rightList.add(true);
    	// stores the resulting map of recursively calling this method on the branch's right child
    	Map<Character, List<Boolean>> rightMap = right.traverse(rightList);
    	// merges the two maps into one and returns it
